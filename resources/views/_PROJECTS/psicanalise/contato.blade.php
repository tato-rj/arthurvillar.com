...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div class="row" style="background-image: url(/_PROJECTS/psicanalise/images/contact.jpg); background-size: cover;">
...
<div class="container my-6">
    <div class="row">
        <div class="col-8 mb-4 mx-auto text-center">
            <p>Você tem alguma dúvida sobre a terapia online e os benefícios desse tratamento?</p>
            <p>A sua resposta está a apenas um clique! Preencha o formulário abaixo para marcar uma consulta ou enviar uma mensagem.</p>
        </div>
    </div>
    <div class="row">
